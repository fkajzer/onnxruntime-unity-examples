...
public class YoloSample : MonoBehaviour
{
    ...
    [SerializeField]
    private Texture ImageToPredict;

    private Yolo inference;
    private TMPro.TMP_Text[] detectionBoxes;
    private readonly StringBuilder sb = new();

    private void Start()
    {
        inference = new Yolo(model.bytes, options);
    ...
    private void UpdateDetectionBox(ReadOnlySpan<Yolo.Detection> detections)
    {
